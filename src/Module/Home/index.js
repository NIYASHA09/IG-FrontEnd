    ...
    <div className='h-screen bg-[#d2cfdf] flex overflow-hidden'>
        <div className='w-[20%] bg-white flex flex-col'>
            <div className='h-[30%] flex justify-center items-center border-b'>
                <div className='flex flex-col justify-center items-center'>
                    ...
                    <h3 className='text-lg  font-semibold'>Lara Jane</h3>
                    <p className='text-xs font-light pb-5'>@Lara_Jane</p>
                    </div>
            ...
            <div className='h-[55%] flex flex-col justify-evenly pl-12 border-b text-gray-400 text-md font-medium'>
                {
                    navigations.map(({id, name, icon}) => {
                        return(
                            <div key={id} className='flex cursor-pointer hover:text-[#F00F51]'><span className='mr-4'>{icon}</span>{name}</div>
                        )
                    })
                }
            ...
            <div className='flex cursor-pointer hover:text-[#F00F51]'><span className='mr-4'><IconLogout /></span>Log Out</div>
            </div>
        </div>
        <div className='w-[60%] overflow-scroll h-full scrollbar-hide'>
            <div className='bg-white h-[65px] border-l border-r flex justify-evenly items-center pt-4 sticky top-0 shadow-lg '>
                ...
                <Button icon={<IconPlus/>} label='Create new post' className='flex rounded-full bg-[#F00F51] hover:[#de0d4c] mb-4 '/>
            </div>
            {
                [1,2,3,4,5].map(() => {
                    return(
        ...
        <div className='w-[20%] bg-white flex flex-col items-center'>
            ...
            <div className='w-[250px] mt-8'>
                ...
                <div className='bg-blue-300 h-[150px]'></div>
            </div>
            <div className='w-[250px] mt-8'>
                <h3 className='text-lg font-semibold mb-4'>Active Followers!</h3>
                <div className='bg-red-400 h-[150px]'></div>
            </div>
        </div>
    </div>
  )
